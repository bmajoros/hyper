...
#=========================================================================
PARM_SPACE={}
PARM_SPACE["ConvDropout"]=(1,) # (0,1)
PARM_SPACE["DropoutRate"]=(0.5,) # (0.2, 0.35, 0.5)
PARM_SPACE["AttentionHeads"]=(8,) # Enformer uses 8; (1,2,3,4,5,6,7,10,20)
PARM_SPACE["DilationFactor"]=(1,) # (1,1,1,1,1,2,3)
PARM_SPACE["AttentionKeyDim"]=(5,5,10,10,25,50) # Enformer uses 64
